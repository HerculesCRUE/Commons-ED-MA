...
namespace CurriculumvitaeOntology
{
	...
	{
        public CV() : base() { } 
		public virtual string RdfType { get { return $"{ActualizadorBase.GetUrlPrefix("roh")}CV"; } }
		public virtual string RdfsLabel { get { return $"{ActualizadorBase.GetUrlPrefix("roh")}CV"; } }
		...
		internal override void GetEntities()
		{
			...
			OntologyEntity entityRoh_personalData = new($"{ActualizadorBase.GetUrlPrefix("roh")}PersonalData", $"{ActualizadorBase.GetUrlPrefix("roh")}PersonalData", "roh:personalData", Roh_personalData.propList, Roh_personalData.entList);
			entList.Add(entityRoh_personalData);

			Roh_professionalSituation.GetProperties();
			Roh_professionalSituation.GetEntities();
			OntologyEntity entityRoh_professionalSituation = new($"{ActualizadorBase.GetUrlPrefix("roh")}ProfessionalSituation", $"{ActualizadorBase.GetUrlPrefix("roh")}ProfessionalSituation", "roh:professionalSituation", Roh_professionalSituation.propList, Roh_professionalSituation.entList);
			entList.Add(entityRoh_professionalSituation);

			Roh_qualifications.GetProperties();
			Roh_qualifications.GetEntities();
			OntologyEntity entityRoh_qualifications = new($"{ActualizadorBase.GetUrlPrefix("roh")}Qualifications", $"{ActualizadorBase.GetUrlPrefix("roh")}Qualifications", "roh:qualifications", Roh_qualifications.propList, Roh_qualifications.entList);
			entList.Add(entityRoh_qualifications);

			Roh_teachingExperience.GetProperties();
			Roh_teachingExperience.GetEntities();
			OntologyEntity entityRoh_teachingExperience = new($"{ActualizadorBase.GetUrlPrefix("roh")}TeachingExperience", $"{ActualizadorBase.GetUrlPrefix("roh")}TeachingExperience", "roh:teachingExperience", Roh_teachingExperience.propList, Roh_teachingExperience.entList);
			entList.Add(entityRoh_teachingExperience);

			Roh_scientificExperience.GetProperties();
			Roh_scientificExperience.GetEntities();
			OntologyEntity entityRoh_scientificExperience = new ($"{ActualizadorBase.GetUrlPrefix("roh")}ScientificExperience", $"{ActualizadorBase.GetUrlPrefix("roh")}ScientificExperience", "roh:scientificExperience", Roh_scientificExperience.propList, Roh_scientificExperience.entList);
			entList.Add(entityRoh_scientificExperience);

			Roh_scientificActivity.GetProperties();
			Roh_scientificActivity.GetEntities();
			OntologyEntity entityRoh_scientificActivity = new ($"{ActualizadorBase.GetUrlPrefix("roh")}ScientificActivity", $"{ActualizadorBase.GetUrlPrefix("roh")}ScientificActivity", "roh:scientificActivity", Roh_scientificActivity.propList, Roh_scientificActivity.entList);
			entList.Add(entityRoh_scientificActivity);

			Roh_freeTextSummary.GetProperties();
			Roh_freeTextSummary.GetEntities();
			OntologyEntity entityRoh_freeTextSummary = new($"{ActualizadorBase.GetUrlPrefix("roh")}FreeTextSummary", $"{ActualizadorBase.GetUrlPrefix("roh")}FreeTextSummary", "roh:freeTextSummary", Roh_freeTextSummary.propList, Roh_freeTextSummary.entList);
