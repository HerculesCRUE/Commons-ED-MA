...
$pageTitle = "Edicion perfil";
$clasePagina = "edicionRecurso edicionPerfil";
$invitado = false;
$comunidad = true;
...
<head>
    ...
    <title>Hércules - Editar perfil</title>
                    ...
                    <div class="col col-12 header-tipo-modal texto-blanco">
                        <div class="container">
                            <div class="modal-header">
                                <p class="modal-title">
                                    <span class="material-icons">mode_edit</span>Editar perfil
                                </p>
                        ...
                        <div class="wrapCol container">
                            <form class="formulario-edicion background-blanco">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="datos-personales-tab" data-toggle="tab" href="#ver-datos-personales" role="tab" aria-controls="ver-datos-personales" aria-selected="true">Datos personales</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="presentate-tab" data-toggle="tab" href="#ver-presentate" role="tab" aria-controls="ver-presentate" aria-selected="true">Presentate a la comunidad</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="redes-sociales-tab" data-toggle="tab" href="#ver-redes-sociales" role="tab" aria-controls="ver-redes-sociales" aria-selected="true">Redes sociales</a>
                                    </li>
                                </ul>
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="ver-datos-personales" role="tabpanel" aria-labelledby="ver-datos-personales-tab">
                                        ...
                                        <div class="form-group mb-5 edit-correo">
                                            ...
                                            <input placeholder="Introduce tu correo electrónico" type="text" name="" id="" class="form-control not-outline">
                                        </div>
                                        <div class="form-group mb-5">
                                            <label class="control-label d-block">País de residencia</label>
                                        ...
                                        <div class="form-group mb-5">
                                            ...
                                            <select id="ddlProvincia" name="ddlProvincia" class="js-select2" data-select-search="true">
                                                <option value="00000000-0000-0000-0000-000000000000">Sin especificar</option>
                                                <option value="01fd88b8-9f7a-4e8b-9507-c6f64f0678c8" selected>La Rioja</option>
                                                <option value="1cb67d02-77ca-4659-bde5-493a9f044603">Navarra</option>
                                                <option value="4ce4d4ef-f984-475d-b3b5-7094fb776c8b">Madrid</option>
                                            </select>
                                        </div>
                                        <div class="form-group mb-5">
                                            <label class="control-label d-block">Localidad</label>
                                            <select id="ddlLocalidad" name="ddlLocalidad" class="js-select2" data-select-search="true">
                                                <option value="00000000-0000-0000-0000-000000000000">Sin especificar</option>
                                                <option value="01fd88b8-9f7a-4e8b-9507-c6f64f0678c8" selected>Logroño</option>
                                                <option value="1cb67d02-77ca-4659-bde5-493a9f044603">Calahorra</option>
                                                <option value="4ce4d4ef-f984-475d-b3b5-7094fb776c8b">Madrid</option>
                                                <option value="78118e78-47fd-490f-92c4-e34797c9b087">Pamplona</option>
                                            </select>
                                        </div>
                                        <div class="form-group mb-5 edit-codpostal">
                                        ...
                                        <div class="form-group mb-5">
                                            ...
                                            <select id="ddlIdioma" name="ddlIdioma" class="js-select2" data-select-search="true">
                                                <option value="01fd88b8-9f7a-4e8b-9507-c6f64f0678c8" selected>Español</option>
                                                <option value="1cb67d02-77ca-4659-bde5-493a9f044603">Inglés</option>
                                                <option value="1cb67d02-77ca-4659-bde5-493a9f044603">Francés</option>
                                                <option value="4ce4d4ef-f984-475d-b3b5-7094fb776c8b">Alemán</option>
                                                <option value="78118e78-47fd-490f-92c4-e34797c9b087">Portugués</option>
                                            </select>
                                        </div>
                                        <div class="form-group mb-5">
                                            <label class="control-label d-block">Sexo</label>
                                            <select id="ddlSexo" name="ddlSexo" class="js-select2" data-select-search="true">
                                                <option value="01fd88b8-9f7a-4e8b-9507-c6f64f0678c8" selected>Hombre</option>
                                                <option value="1cb67d02-77ca-4659-bde5-493a9f044603">Mujer</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade show" id="ver-presentate" role="tabpanel" aria-labelledby="ver-presentate-tab">
                                        <div class="form-group mb-5 edit-descripcion">
                                            <label class="control-label d-block">Descripción</label>
                                            <textarea id="txtDescripcion" placeholder="Cuéntales en pocas palabras quién eres, a qué te dedicas, cuáles son tus gustos..." class="cke form-control recursos" cols="20" rows="1"></textarea>
                                        </div>
                                        <div class="form-group mb-5 edit-etiquetas">
                                            ...
                                            <div class="autocompletar autocompletar-tags form-group">
                                                <div class="input-wrap form-sticky-button">
                                                    <input type="text" placeholder="Buscar o introduce una etiqueta nueva" id="txtTags" class=" form-control" autocomplete="off">
                                    ...
                                    <div class="tab-pane fade show" id="ver-redes-sociales" role="tabpanel" aria-labelledby="ver-redes-sociales-tab">
                                        <div class="form-group mb-4 edit-red-social">
                                            <label class="control-label d-block">Twitter</label>
                                            <div class="input-wrap form-social">
                                                <input placeholder="Introduce tu cuenta de Twitter" type="text" name="" id="" class="form-control not-outline">
                                        ...
                                        <div class="form-group mb-4 edit-red-social">
                                            ...
                                            <div class="input-wrap form-social">
                                                <input placeholder="Introduce tu cuenta de Facebook" type="text" name="" id="" class="form-control not-outline">
                                        ...
                                        <div class="form-group mb-4 edit-red-social">
                                            ...
                                            <div class="input-wrap form-social">
                                                <input placeholder="Introduce tu cuenta de Linkedin" type="text" name="" id="" class="form-control not-outline">
                                ...
                                <a href="javascript: void(0);" class="btn btn-primary uppercase">Guardar</a>
