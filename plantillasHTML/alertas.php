...
<body class="<?php include './shared/clasesBody.php'; ?>" cz-shortcut-listen="true">
    ...
    <main role="main">
            ...
            <div class="row-content">
                <div class="row">
                        ...
                        <div class="wrapCol">
							<div class="header-contenido">
                                <div class="h1-container">
                                    <h1>Alertas <span class="numResultados">14</span></h1>
								</div>
							</div>
							<?php include './shared/alertas/contenido.php'; ?>
					...
					<div class="col col-12 col-xl-4 col-lateral col-contexto derecha">
						<?php include './shared/alertas/menuLateral.php'; ?>
						<?php include './shared/relacionados/grupo-investigadores.php'; ?>
					</div>
				</div>
			</div>
		</main>
		...
		<?php include './shared/alertas/modales/modal-anadir-item-cv.php'; ?>
		<?php include './shared/alertas/modales/modal-fusionar.php'; ?>
	</body>
</html>