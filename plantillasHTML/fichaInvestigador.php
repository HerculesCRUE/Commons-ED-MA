<?php
    ...
    $pageTitle = "Ficha Investigador";
    $clasePagina = "fichaRecurso fichaRecurso-investigador";
    $invitado = false;
    $comunidad = true;
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col col-12 col-xl-12 col-contenido">
                    <div class="wrapCol">
                        <?php include './shared/investigador/cabecera-investigador.php' ?>
                        <?php include './shared/investigador/contenido-investigador.php' ?>
                    </div>
                </div>
            </div>
        </div>
