                        ...
                        <div class="wrapCol">
                            <div class="header-contenido">
                                <div class="h1-container">
                                    <h1>Mensajes <span class="numResultados">425</span></h1>
                                </div>
                                <?php include './shared/acciones/acciones-listado-compactado.php'; ?>
                                <?php include './shared/filtros-listado.php'; ?>
                                <?php include './shared/acciones/acciones-listado-mensajes.php'; ?>
                            </div>
                            <?php include './shared/listado-mensajes.php'; ?>
