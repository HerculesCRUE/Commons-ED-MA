<?php
    ...
    $clasePagina = "aceptar-invitacion";
    $invitado = true;
    $comunidad = true;
    $listado = false;
...
<head>
    ...
    <title>Hércules - Aceptar invitación</title>
                    ...
                    <div class="form formularioRegistroUsuarios panel-centrado">
                        ...
                        <div class="box box01">
                            ...
                            <div id="divKodatosUsuario">
                                <div class="ko"><p>Debes rellenar todos los campos marcados con *</p><p>El correo electrónico no es válido</p><p>La contraseña debe tener entre 6 y 12 caracteres, al menos una letra y un número, y no puede contener caracteres especiales, excepto: # _ $ *</p><p>Debes establecer la fecha de nacimiento</p></div>
                            </div>
                            <div class="custom-control custom-checkbox mb-4">
                                <input type="checkbox" id="proteger-version" name="proteger-version" class="custom-control-input">
                                <label class="custom-control-label texto-gris-medio" for="proteger-version">He leído y acepto la <a class="link" data-target="#modal-politica-privacidad" data-toggle="modal"> política de privacidad</a> de Hércules.</label>
                            </div>
                            <div id="divKoCondicionesUso">
                                <div class="ko"><p>Debes leer y aceptar las condiciones de acceso y uso</p></div>
                            </div>
                            <div class="actionButtons">
                                <div class="mb-3">
                                    <input type="submit" value="Aceptar invitación" class="btn btn-primary principal submit uppercase" id="btnCrearCuenta" onclick="if(ComprobarDatosRegistro('18')) {return false;}">
                                </div>
                                <div class="form-group mb-3">
                                    <label class="control-label d-block">Apellidos</label>
                                    <input placeholder="Introduce tus apellidos" type="text" name="" id="" class="form-control not-outline">
