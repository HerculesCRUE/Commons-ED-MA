                        ...
                        <div class="wrapCol">
                            <div class="header-contenido">
                                <div class="h1-container">
                                    <h1>Otros resultados de investigación <span class="numResultados">2400</span></h1>
								</div>
								<?php include './shared/acciones/acciones-listado-buscador.php'; ?>
							</div>
							<?php include './shared/listado-buscador-ros.php'; ?>
