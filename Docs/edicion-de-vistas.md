...
Adicionalmente las fichas de consulta pueden utilizar métodos específicos creados en el [servicio externo](https://github.com/HerculesCRUE/CommonsED-MA/tree/main/src/Hercules.CommonsEDMA.ServicioExterno) para realizar determinadas acciones como el pintado de gráficas
